        ...
        async with self.semaphore:
            ...
            try:
                ...
                batch_result = BatchResult(
                    ...
                    hook_fact_check=result['hook_fact_check'].overall_status if result.get('hook_fact_check') else None,
                    medium_fact_check=result['medium_fact_check'].overall_status if result.get('medium_fact_check') else None,
                    expanded_fact_check=result['expanded_fact_check'].overall_status if result.get('expanded_fact_check') else None,
